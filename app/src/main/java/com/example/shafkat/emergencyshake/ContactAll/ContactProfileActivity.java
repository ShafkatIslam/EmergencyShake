...
//        final String number=bundle.getString("number");
        ...
        EventButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ContactProfileActivity.this,EventActivity.class);
...
//                        }
                        ...
                        {
                            Toast.makeText(ContactProfileActivity.this,"Choose Blood Group",Toast.LENGTH_SHORT).show();
                        }
                        ...
                        {
                            Toast.makeText(ContactProfileActivity.this,"Please select a blood group",Toast.LENGTH_SHORT).show();
                        }
                        ...
                        else
                        {
                            try{
                                ...
                                new Compressor(ContactProfileActivity.this)
...
//                            long rowId1 = myDatabaseHelper.insertData3(name,number,imageToString(bitmap3)); //method is calling
                                                ...
                                                if(rowId1 > -1)
                                                {
                                                    Toast.makeText(ContactProfileActivity.this, "Saved Successfully", Toast.LENGTH_SHORT).show();
                                                }
...
//                                                    if(rowId1 > -1)
                                                    {
                                                        Toast.makeText(ContactProfileActivity.this, "Updated Successfully", Toast.LENGTH_SHORT).show();
                                                    }
...
//                        x = size/Math.pow(1024, digitGroups);
                        ...
                        {
                            Toast.makeText(ContactProfileActivity.this,"Image size is too large",Toast.LENGTH_SHORT).show();
                        }
...
//                        homeImageView.setImageBitmap(bitmap3);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == IMG_REQUEST)
        {
            ...
            {
                Toast.makeText(ContactProfileActivity.this,"You don't have permission to access file location",Toast.LENGTH_SHORT).show();
            }
...
//            super.onBackPressed();
//        }
        Intent intent = new Intent(ContactProfileActivity.this,ContactAllActivity.class);
        startActivity(intent);
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Intent intent = new Intent(ContactProfileActivity.this,HomeActivity.class);
            startActivity(intent);
        }

        else if (id == R.id.emergenyList) {

            Intent intent = new Intent(ContactProfileActivity.this,EmergencyListActivity.class);
            startActivity(intent);
            // Handle the camera action
        } else if (id == R.id.emergenySms) {

            Intent intent = new Intent(ContactProfileActivity.this,EmergencySmsActivity.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(ContactProfileActivity.this,GroupCreateActivity.class);
            startActivity(intent);

        } else if (id == R.id.groupContacts) {
            Intent intent = new Intent(ContactProfileActivity.this,GroupContactsActivity.class);
            startActivity(intent);

        } else if (id == R.id.sendSms) {

            Intent intent = new Intent(ContactProfileActivity.this,SendSmsActivity.class);
            startActivity(intent);

        }else if (id == R.id.reminder) {

            Intent intent = new Intent(ContactProfileActivity.this,ReminderActivity.class);
            startActivity(intent);

        }else if (id == R.id.blood) {

            Intent intent = new Intent(ContactProfileActivity.this,BloodSearchActivity.class);
            startActivity(intent);

        }else if (id == R.id.settings) {
            Intent intent = new Intent(ContactProfileActivity.this,MainActivity.class);
            startActivity(intent);
